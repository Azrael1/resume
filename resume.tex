...
\item
	...
	\ressubheadingb{B.Tech Electronics \& Communication Engineering : GPA 3.06/4.00}{August 2012 - May 2016}
\end{itemize}
...
\begin{itemize}
\item
    \ressubheadinga{Chubb Insurance}{Bengaluru, India}
    \ressubheadingb{Analyst (full time position)}{March 2021 - Present}
    \begin{itemize}
        \resitem{Building a website searching and scraping solution for Chubb's potential clients}
        \resitem{Developing a summarization model as a part of digital underwriter assistant application that summarizes business operations for Chubb's potential clients.}
        \resitem{Summarization model uses transformer model \href{https://arxiv.org/abs/1910.13461}{\emph{BART}}, with included  NER removal \& tagging to provide precise \& trustworthy summaries.}
    \end{itemize}
\end{itemize}
...
\item
    ...
    \ressubheadingb{Trainee Decision Scientist (full time position)}{May 2016 - November 2016}
    \begin{itemize}
